...
class AIRSIM_API UWeatherLib : public UBlueprintFunctionLibrary
{
	...
	{
		return FString(TEXT("AActor'/AirSim/Weather/UI/MenuActor.MenuActor_C'"));
	}

	static const FSoftClassPath getWeatherActorPath()
	{
		return FString(TEXT("AActor'/AirSim/Weather/WeatherFX/WeatherActor.WeatherActor_C'"));
	}

	static const FSoftClassPath getWeatherMenuWidgetClass()
	{
		return FString(TEXT("UUserWidget'/AirSim/Weather/UI/OptionsMenu.OptionsMenu_C'"));
	}
